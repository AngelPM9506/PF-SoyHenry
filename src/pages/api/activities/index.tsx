...
export default async function index(req: NextApiRequest, res: NextApiResponse) {
    let { method, body: { name, availability, description, price } } = req;
    switch (method) {
        ...
        case 'POST':
            ...
            if (!name || !availability || !Object.values(weekdays).includes(availability) || !description || !price) return res.status(400).json({ msg: 'Missing data, try again' });
            let activity = { data: { name, availability, description, price } };
            try {
